...
{#if name && id}
	<button
		...
		class="mt-8 flex cursor-pointer flex-row items-center gap-x-3 rounded border border-white/10 bg-transparent px-10 py-2.5 text-white hover:border-white/50"
	>
